 ...
 type OrdersSectionProps = {
  ...
  orderDetailId: string;
   ...
   orderQuickId: string;
   setOrderQuickId: (value: string) => void;
   handleQuickOrder: () => void;
   orderQuickMessage: string | null;
   orderQuickSummary: any | null;
   handleQuickToDelivery: () => void;
   ...
   return (
     <>
       <div className="grid gap-4">
         ...
         <SectionCard
           title="Panel 1-klik"
           description="System sam zdecyduje: wydaj zamowienie albo przygotuj dostawe."
         ...
         >
             ...
             {orderQuickSummary && (
               <div className="grid gap-2 text-sm">
                 <p className="text-sm text-muted-foreground">
                   Braki na stanie. Przejdz do dostaw, a produkty beda juz wypelnione.
                 </p>
                 {orderQuickSummary.items
                   .filter((item: any) => item.missing > 0)
                   .map((item: any) => (
                     <div key={item.product_id} className="rounded-md border bg-white px-3 py-2">
